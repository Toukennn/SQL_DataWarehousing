...
AS
BEGIN
    SET NOCOUNT ON; -- Not sending the ‘(X rows affected)’ message after each statement.
    ...
    BEGIN TRY
        -- Change only this line if the repo is stored elsewhere
        SET @base_path = 'C:\SQL_DataWarehousing\datasets\';
        ...
        SET @sql = '
            ...
            WITH (
                FIRSTROW = 2, --Ignoring the table headers
                FIELDTERMINATOR = '','',
                TABLOCK
            );';
